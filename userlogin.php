...
if(isset($_POST['submit']))
{
    ...
    $sql = "INSERT INTO `login` (`username`,`password`,`cpassword`,`email`) VALUES ('$uname','$pwd','$cpwd','$email')";
    $ex = $conn->query($sql);    
...
<div class="workaraea">
    ...
    <table align="center">
        <tr>
            <td>UserName</td>
            <td><input type="text" name="uname" class="form_text" id="form_uname"></td><td><span class="error_form" id="username_error_message"></span></td>
        </tr>
        <tr>
            <td>Password</td>
            <td><input type="text" name="pwd" class="form_text" id="form_pwd"></td><td><span class="error_form" id="password_error_message"></span></td>
        </tr>
        <tr>
            <td>Retype-Password</td>
            <td><input type="text" name="cpwd" class="form_text" id="form_cpwd"></td><td><span class="error_form" id="cpwd_error_message"></span></td>
        </tr>
        <tr>
            <td>Email</td>
            <td><input type="text" name="email" class="form_text" id="form_email"></td><td><span class="error_form" id="email_error_message"></span></td>
        </tr>
        <tr>
